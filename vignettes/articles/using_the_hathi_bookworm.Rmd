...
#>    htid                      title                                                                       url                                      
#>    <chr>                     <chr>                                                                       <chr>                                    
#>  1 nc01.ark:/13960/t2v41mn4r Teaching democracy in the North Carolina public schools /--- 1941           https://babel.hathitrust.org/cgi/pt?id=n~
#>  2 uc1.$b67929               The education of free men in American democracy.                            https://babel.hathitrust.org/cgi/pt?id=u~
#>  3 mdp.39015062763720        The education of free men in American democracy.                            https://babel.hathitrust.org/cgi/pt?id=m~
#>  4 mdp.39015068297905        The education of free men in American democracy.--- suppl.                  https://babel.hathitrust.org/cgi/pt?id=m~
#>  5 uc1.$b67873               Pennsylvania bill of rights week. Recommendations for school observance ... https://babel.hathitrust.org/cgi/pt?id=u~
#>  6 mdp.39015035886111        Education in a world of fear,                                               https://babel.hathitrust.org/cgi/pt?id=m~
#>  7 mdp.39015031665543        Education and the morale of a free people.                                  https://babel.hathitrust.org/cgi/pt?id=m~
#>  8 uc1.$b67928               Education and the morale of a free people.                                  https://babel.hathitrust.org/cgi/pt?id=u~
#>  9 uiug.30112108068831       Proceedings of the convention.--- 19 1941                                   https://babel.hathitrust.org/cgi/pt?id=u~
#> 10 uc1.b4305220              Guidance in democratic living,--- copy D11                                  https://babel.hathitrust.org/cgi/pt?id=u~
#> # ... with 90 more rows
```

If you need a bigger sample, use the function `workset_builder()` to query the Hathi Trust's [Workset Builder 2.0](https://solr2.htrc.illinois.edu/solr-ef/); this can help you download even hundreds of thousands of volume IDs that meet specified criteria. See the article on see the article "[Topic Models Using Hathi Extracted Features](topic_models_using_hathi_ef)" for more examples of how to use this facility.
...
#>  1 http://catal~           1.3 nc01.ark:/13960/~ und              Teaching dem~ "[\"bib~    1941 ncu      text           BK               eng     
#>  2 http://catal~           1.3 uc1.$b67929       pd               The educatio~ "[\"bib~    1941 dcu      text           BK               eng     
#>  3 http://catal~           1.3 mdp.390150627637~ pd               The educatio~ "[\"bib~    1941 dcu      text           BK               eng     
#>  4 http://catal~           1.3 mdp.390150682979~ pd               The educatio~ "[\"bib~    1941 dcu      text           BK               eng     
...
#>  7 http://catal~           1.3 mdp.390150316655~ pd               Education an~ "[\"not~    1941 dcu      text           BK               eng     
#>  8 http://catal~           1.3 uc1.$b67928       pd               Education an~ "[\"not~    1941 dcu      text           BK               eng     
#>  9 http://catal~           1.3 uiug.30112108068~ ic               Proceedings ~ "[\"con~    1941 onc      text           SE               eng     
#> 10 http://catal~           1.3 uc1.b4305220      ic               Guidance in ~ "[\"bib~    1941 nyu      text           BK               eng     
#> # ... with 90 more rows, and 25 more variables: dateCreated <dttm>, lastUpdateDate <dttm>, imprint <chr>, isbn <chr>, issn <chr>, oclc <chr>,
#> #   lccn <chr>, classification <chr>, handleUrl <chr>, hathitrustRecordNumber <dbl>, sourceInstitutionRecordNumber <chr>,
#> #   sourceInstitution <chr>, accessProfile <chr>, enumerationChronology <chr>, governmentDocument <chr>, names <chr>, issuance <chr>,
#> #   subjectGenre <chr>, subjectTopic <chr>, subjectName <chr>, subjectTitleInfo <chr>, subjectTemporal <chr>, subjectGeographic <chr>,
#> #   subjectOccupation <chr>, subjectCartographics <chr>
```
