...
See the articles "[Topic Models Using Hathi Extracted Features](articles/topic_models_using_hathi_ef)" and "[An Example Workflow](articles/example_workflow)" for more on rsyncing large numbers of Hathi Trust JSON extracted features files and caching them to other formats for analysis.
