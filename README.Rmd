...
See `vignette("using_the_hathi_bookworm")` for more on how to query the bookworm to get word frequencies grouped by particular fields and limited to specific categories.
...
See the vignette `vignette("using_worksets")` for more on creating and working with worksets.
...
This requires having rsync installed; see the vignette `vignette("using_worksets")` for more on rsyncing large numbers of Hathi Trust IDs.
