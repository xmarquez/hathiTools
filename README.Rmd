...
This requires having rsync installed; see the article "[Topic Models Using Hathi Extracted Features](topic_models_using_hathi_ef)" for more on rsyncing large numbers of Hathi Trust JSON extracted features files and caching them to other formats for analysis.
